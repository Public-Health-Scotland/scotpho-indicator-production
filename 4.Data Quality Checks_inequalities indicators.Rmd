...
adp_quintiles <- any(substr(data_indicator$code,1,3) == "S11")
...
Alcohol and Drugs Partnership: `r adp_quintiles`<br>
...
if(adp_quintiles == TRUE) {ft_sc_quin_check<- ft_sc_quin_check %>%  color(~ S11!=30, ~S11, color = "red")} # Should be 30 ADPs
...
ft_hb_quin_check <- geo_checks %>%
  ...
  color(~ !is.na(S11), ~S11, color = "red") %>% # Should be no records for ADPs
