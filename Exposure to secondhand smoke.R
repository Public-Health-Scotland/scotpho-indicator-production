...
exposure_smoking <- read_csv(paste0(data_folder, "Received Data/IR2020-00981_secondhandsmoke_valid_used.csv")) %>%
...
ca_lookup <- readRDS('/conf/linkage/output/lookups/Unicode/Geography/Scottish Postcode Directory/Scottish_Postcode_Directory_2020_2.rds') %>% 
...
analyze_first(filename = "exposure_smoking", geography = "council", hscp = T,
              measure = "percent", yearstart = 2002, yearend = 2019, time_agg = 3)
