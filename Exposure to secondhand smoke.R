...
exposure_smoking <- read_csv(paste0(data_folder, "Received Data/IR2021-00906_secondhandsmoke_valid_used.csv")) %>%
...
ca_lookup <- readRDS('/conf/linkage/output/lookups/Unicode/Geography/Scottish Postcode Directory/Scottish_Postcode_Directory_2021_2.rds') %>% 
...
analyze_first(filename = "exposure_smoking", geography = "council", hscp = T,
              measure = "percent", yearstart = 2002, yearend = 2020, time_agg = 3)
