...
smoking_deaths <- as_tibble(dbGetQuery(channel, statement=paste0(
    ...
    WHERE date_of_registration between '1 January 2012' and '31 December 2023'
         AND sex <> 9
         AND age > 34
         AND country_of_residence='XS'
         AND council_area is not null
         AND regexp_like(UNDERLYING_CAUSE_OF_DEATH, '", smoking_diag, "')
    "))) |>
...
smoking_deaths_2 <- left_join(smoking_deaths_2, area_prevalence, by = c("code", "year", "sex_grp")) |>  
