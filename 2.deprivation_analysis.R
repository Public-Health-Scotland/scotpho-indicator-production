...
# qa - (default is true) the qa report is generated by default but switching to FALSE will skip generation of QA report.
...
run_ineq_qa <- function(filename, qa=TRUE, old_file="default", check_extras=c()){
