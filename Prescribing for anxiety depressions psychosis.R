...
presc_anx <- read_csv(file=paste0(data_folder, 'Received Data/prescrib_anx_depression_ScotPHO Indicator by Datazone 2010 to 2019.csv')) %>% 
...
analyze_deprivation(filename="prescriptions_anxiety_depr", measure="percent", time_agg=1, 
                    yearstart= 2014, yearend=2019,   year_type = "financial", 
