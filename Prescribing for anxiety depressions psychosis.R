...
presc_anx <- read_csv(file=paste0(data_folder, 'Received Data/prescrib_anx_depression_ScotPHO Indicator by Datazone 2010 to 2020.csv')) %>% 
...
analyze_first(filename = "prescriptions_anxiety", geography = "datazone11", pop= "DZ11_pop_allages",
              measure = "percent", yearstart = 2010, yearend = 2020, time_agg = 1)
...
analyze_deprivation(filename="prescriptions_anxiety_depr", measure="percent", time_agg=1, 
                    yearstart= 2014, yearend=2020,   year_type = "financial", 
