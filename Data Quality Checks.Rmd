...
#Edinburgh localities = S99000042,43,44,45
...
edinburgh_chart <- ggplot(data = data_indicator %>% 
         filter((code =="S12000036" | code=="S37000012"
                |code=="S99000042"|code=="S99000043"|code=="S99000044"|code=="S99000045") 
                & year== max(year)), aes(areaname, rate)) +
  geom_point(stat = "identity") +
...
edinburgh_data <- data_indicator %>%        # create data frame filtered for edinburgh geographies
  filter(code =="S12000036" | code=="S37000012" | code=="S99000042"| 
           code=="S99000043"|code=="S99000044"|code=="S99000045") %>%
