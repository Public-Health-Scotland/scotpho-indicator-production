...
if(!is.null(old_filename)) {old_filename <- filename}
...
# if(all(data_indicator$numerator != "") && check_tot !=0){
...
# Print statement regarding 
case_when((all(data_indicator$numerator != "") && sum(edinburgh_data$check_tot)==0) ~ 
              "Numerators for Edinburgh council, HSCP and localities all agree :-)",
