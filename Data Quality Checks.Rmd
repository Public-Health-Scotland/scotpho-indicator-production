...
# } else if (skip=="y"){
#   old_data_indicator <-"no comparison file"
# }


test_old_indicator_data <- paste0(data_folder, "Shiny Data/", filename, "_shiny.csv")

if(file.exists(test_old_indicator_data)) {
  skip_checks <-"n"
  old_data_indicator <- read_csv(paste0(data_folder, "Shiny Data/", filename, "_shiny.csv")) 
} else {
  skip_checks <-"y"
  old_data_indicator <-"no comparison file"
}
...
**Old** indicator file (for comparisons):  /`r (paste0(test_old_indicator_data)) `<br>
