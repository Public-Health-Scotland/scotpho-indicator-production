## September 2025 indicator script archived and replaced by 
## Active travel to work.R

#This script was archived as the methodology used was incorrectly calculating percentages based on scottish populations 
# rather than taking the percentages & confidence intervals already calculated by survey team 
