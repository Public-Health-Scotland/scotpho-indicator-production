...
## OLD CODE FOR EXPANDING THE SERIES DUE TO INCONSISTENT TIME SERIES: 
## ADDING IN NA YEARS MAKES SURE THE X-AXIS SHOWS TIME CORRECTLY
## UNSURE IF NEEDED? WILL LOOK HOW PLOTS IN THE APP, AND ADJUST IF NEEDED
