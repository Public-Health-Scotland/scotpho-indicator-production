...
## Part 1 - Prepare basefile ----
###############################################.
mat_obesity <- read_csv(paste0(data_folder, "Received Data/Maternal Obesity/IR2024-00001_obesity.csv")) %>%
...
analyze_first(filename = "mat_obesity", geography = "datazone11", measure = "percent", 
              yearstart = 2010, yearend = 2022, time_agg = 3)
...
analyze_deprivation(filename="mat_obesity_depr", measure="percent", time_agg=3, 
                    yearstart= 2014, yearend=2022, year_type = "financial", ind_id = 13021)
