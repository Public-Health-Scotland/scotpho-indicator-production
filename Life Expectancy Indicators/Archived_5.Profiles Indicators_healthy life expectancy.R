# REDUCTION IN ANNUAL POPULATION SURVEY (APS) SAMPLE SIZE RESULTED IN CHANGES TO 
# METHODOLOGY BEHIND CALCULATION OF HLE BY ONS/NRS PRODUCED IN  JULY 2025
# THIS NEW METHODOLOGY RESULTS IN FIGURES THAT ARE NOT CONSISTENT WITH PREVIOUSLY
# PUBLSHED ESTIMATES.
# AS OF 29 JULY 2025 THIS SCRIPT IS ARCHIVED AND NO NEW ESTIMATES OF THIS TIME SERIES WILL BE CALCULATED
