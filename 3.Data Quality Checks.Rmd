...
###**Data check 6b:**
<br>
####Do numerators sum like they should _Council and NHS Board comparisons, 
Checking if the numerators for councils sum to health board - for some indicators there are no numerators 

```{r, include=FALSE}

# calculate sum of numerators for locality data and compare to parent hscp total
# this might flat if hscp localities are incorrectly labelled, for example when LIST datazone to HSCP locality lookup isn't updated 
...
check_council <- left_join(x=data_hb, y=council_sum, by = c("code"="hb2019","year"))|>
