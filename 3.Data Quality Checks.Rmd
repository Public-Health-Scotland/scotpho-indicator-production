...
old_indicator_filepath <- paste0(profiles_data_folder, "/Shiny Data/", filename, "_shiny.rds") #create value which is file path to old file
...
if(file.exists(old_indicator_filepath)) {
  ...
  old_data_indicator <- readRDS(paste0(profiles_data_folder, "/Shiny Data/", filename, "_shiny.rds"))
