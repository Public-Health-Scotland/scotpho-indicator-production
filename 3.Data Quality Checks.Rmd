...
#Read in indicator file being checked (switch file path to a different location if working on test indicators)
...
If dataset contains numerators check if for agreement between council, NHS board and partnership areas in Lothian/Edinburgh. <br>
...
If there are large discrepanies consider if the HSCP locality lookup is correct.<br>
```{r, echo=FALSE}
if(locality==TRUE & numerators_present == TRUE){
