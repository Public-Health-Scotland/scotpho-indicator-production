...
hpv_data <- rbind(hpv_data_18, hpv_data_17, hpv_data_old) #merging both together
...
analyze_first(filename = "hpv_uptake", geography = "datazone11", measure = "percent", 
              yearstart = 2009, yearend = 2018, time_agg = 3)
...
analyze_deprivation(filename="hpv_uptake", measure="percent", time_agg=3, 
                    yearstart= 2014, yearend=2018,   year_type = "school", 
                    ind_id = 13032)
