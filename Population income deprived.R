...
saveRDS(data_inc_dep, file = paste0(prepared_data, "income_deprived_depr_raw.rds"))

#File for DZ11 for 2014 onwards
data_inc_depdz11 <- data_inc_dep %>% filter(year>2013)

saveRDS(data_inc_depdz11, file = paste0(prepared_data, "income_deprived_dz11_raw.rds"))
...
saveRDS(data_inc_depdz01, file = paste0(prepared_data, "income_deprived_ca_raw.rds"))
...
all_data <- rbind(readRDS(paste0(temporal_data, "income_deprived_dz11_formatted.rds")),
                  readRDS(paste0(temporal_data, "income_deprived_ca_formatted.rds")))
saveRDS(all_data, file = paste0(temporal_data, "income_deprived_all_formatted.rds"))
