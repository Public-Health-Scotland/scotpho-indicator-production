...
mapply(read_simd, data = "DataZone2011_simd2020v2", simd = "simd2020v2_inc_dep_n", 
...
saveRDS(data_shiny_filtered, file = paste0("/PHI_conf/ScotPHO/Profiles/Data/", "Data to be checked/", "income_deprived_all", "_shiny.rds"))
write_csv(data_shiny_filtered, file = paste0("/PHI_conf/ScotPHO/Profiles/Data/", "Data to be checked/", "income_deprived_all", "_shiny.csv"))
saveRDS(data_shiny_deprivation_filtered, file = paste0("/PHI_conf/ScotPHO/Profiles/Data/", "Data to be checked/", "income_deprived_depr_ineq.rds"))
