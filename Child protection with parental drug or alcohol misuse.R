...
# POP LOOKUP 1: Make pop lookup for the main_analysis function (no age/sex splits)
...
# POP LOOKUP 2: Make pop lookup to use for popgroups data:
...
main_analysis(filename = "IRD_2023", ind_id = 30169, geography = "council", measure = "crude",
              pop = "CA_pop_under18_to2024", yearstart = 2023, yearend = 2023,
