...
data_indicator <- readRDS(paste0(data_folder, "Data to be checked/", filename, "_depr_ineq.rds")) 
...
old_data_indicator <- readRDS(paste0(data_folder, "Shiny Data/", old_filename, "_depr_ineq.rds")) 
