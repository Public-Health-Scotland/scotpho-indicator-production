...
analyze_second(filename = "scra_offence", measure = "crude", time_agg = 1,
              ind_id = 20803, year_type = "financial", crude_rate = 1000, qa=FALSE)

#for QA
scra_offence_denom <- readRDS(paste0(data_folder, "Temporary/scra_offence_formatted.rds"))

write.csv (scra_offence_denom, paste0(data_folder, "Temporary/scra_offence_formatted.csv"))
