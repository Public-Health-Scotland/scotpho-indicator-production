...
main_analysis <- function(filename,
  ...
  if(!is.null(pop)){
    ...
    # Temporary step used for indicators being updated to include 2024 data that we publish at IZ/Locality level prior to the release of SAPE 2024
    ...
    # This code can be adapted if major delays occur again.
    # 
