## MM Jan 2026:
# Partial update done at CA level and above to include 2024/25 for main indicator file only. 
# Analysis functions to be re-run Spring 2026:
# - re-run main_analysis (no changes to parameters needed)
# run deprivation_analysis (change yearend to 2024)
...
###############################################.
# Datazone2011
hospitalisation_CHD_dz11 <- hospitalisation_CHD %>% 
...
hospitalisation_CHD_dz01 <- hospitalisation_CHD %>% 
...
## Part 3 - Run analysis functions ----
###############################################.
main_analysis(filename = "hospitalisation_CHD_dz11", geography = "datazone11", measure = "stdrate", 
              pop = "DZ11_pop_allages", yearstart = 2002, yearend = 2024,
              time_agg = 3, epop_age = "normal", epop_total = 200000, ind_id = 20303, year_type = "financial")
