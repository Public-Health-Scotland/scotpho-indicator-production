...
## Part 1 - Prepare basefile ----
###############################################.
premature <- read_csv(paste0(data_folder, "Received Data/Premature Births/IR2024-00846_premature.csv")) %>%
...
analyze_deprivation(filename="premature_births_depr", measure="percent", time_agg=3, 
                    yearstart= 2014, yearend=2023, year_type = "financial", ind_id = 13022)
